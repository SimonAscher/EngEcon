...
def power_scale(baseline_size, design_size, baseline_cost, scaling_factor=0.7):
    ...
    scaling_factor: float
        Scaling factor to be used in power scaling method - also see note for more information.
    ...
    (e.g. Angelonidi & Smith (2015) (https://doi.org/10.1111/wej.12130) uses a more linear f closer to 1.0).
    """
...
def CEPCI_scale(base_year, design_year, value):
    ...
    """
    # Get CEPCI values
    CEPCI_data = toml.load("data/CEPCI_value.toml")["CEPCI"]
